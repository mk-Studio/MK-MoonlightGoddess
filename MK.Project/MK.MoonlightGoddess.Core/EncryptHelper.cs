...
namespace MK.MoonlightGoddess.Core
{
    ...
    public class EncryptHelper
    {
       ...
       #region Sufei
       //密钥
       private static byte[] arrDESKey = new byte[] { 31, 8, 96, 19, 19, 94, 6, 10 };
       private static byte[] arrDESIV = new byte[] { 19, 46, 2, 15, 15, 2, 46, 19 };
       ...
       /*透明的心 BKY*/
        ...
        private static readonly string Default_AES_Key = "@#mk456";
